...
SUBCATEGORIES = {
    ...
    "research": {
        ...
        "report_ja": "日本語レポート: 日本の民間シンクタンク（ニッセイ基礎研・大和総研・第一生命経済研等）の日本語レポート（省庁・審議会の資料は government カテゴリへ）",
    },
    "government": {
...
要件:
- expenditure / revenue / government は各カテゴリ最大3件、international は最大5件、research はサブカテゴリごとに最大2件。合計で最大22件まで。新しく重要なものを優先する。
...
def make_id(category: str, date: str, url: str = "") -> str:
    prefix = {
        ...
        "research": "res", "government": "gov", "digest": "dig",
    }[category]
    if category == "digest":
